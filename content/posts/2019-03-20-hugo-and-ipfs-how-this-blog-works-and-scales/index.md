...
{{< img src="pageviews.png" alt="Pageviews chart: from just a few hundreds per day up to 6,000 in a day" >}}
...
{{< img src="cpu.png" alt="CPU chart: nothing changed" >}}
...
{{< img src="running-vms.png" alt="IPFS cluster nodes on Azure" >}}
